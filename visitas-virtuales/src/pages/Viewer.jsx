...
import { UserCheck, ShieldCheck, GraduationCap, MapPin, Pencil, X } from 'lucide-react';
...
export default function Viewer() {
	...
	// Estado del modo edición — solo los admins pueden activarlo
	// Se pasa como prop a UnityViewer para que envíe el flag a Unity
	...
	return (
		...
		>
			<div className="flex items-center justify-between">
				...
				{/* Botón modo edición — solo visible para administradores */}
				{isAdmin && (
					<button
						...
						className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
							modoEdicion
								...
								: 'bg-navy-muted text-navy hover:bg-navy/10'
						}`}
					>
						{modoEdicion ? (
							<>
			...
			<div className="lg:p-6 overflow-hidden bg-white border rounded-xl shadow-xl/6 border-slate-100">
				...
				{selectedCenter ? (
					<UnityViewer modoEdicion={modoEdicion} />
				) : (
